 ...
 * @method static string validateFilename(string $filename)
 * @method static array{primary: bool, filename: string, url: string}|null getPrimaryFile(array<int, array{primary: bool, filename: string, url: string}> $files)
 * @method static void performInstallOrUpdate(Server $server, ModrinthProjectType $modrinthProjectType, array{project_id: string, slug: string, title: string, author?: ?string} $record, array<string, mixed> $versionData, array{primary: bool, filename: string, url: string} $primaryFile, ?array $installedMod = null)
