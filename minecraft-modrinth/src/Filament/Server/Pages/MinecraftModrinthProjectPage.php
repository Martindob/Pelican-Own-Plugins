                ...
                Action::make('versions')
                    ...
                    ->schema(function (array $record) {
                        ...
                        foreach ($versions as $versionIndex => $versionData) {
                            $primaryFile = MinecraftModrinth::getPrimaryFile($versionData['files'] ?? []);
                                ...
                                $headerAction = Action::make('install_version_' . $versionIndex)
                                    ...
                                    ->action(function () use ($record, $versionData, $primaryFile) {
                                        try {
                                            ...
                                            MinecraftModrinth::performInstallOrUpdate($server, static::$modrinthProjectType, $record, $versionData, $primaryFile, $installedMod);
                ...
                Action::make('install_latest')
                    ...
                    ->action(function (array $record) {
                        try {
                            ...
                            MinecraftModrinth::performInstallOrUpdate($server, static::$modrinthProjectType, $record, $latestVersion, $primaryFile);
                ...
                Action::make('update')
                    ...
                    ->action(function (array $record) {
                        try {
                            ...
                            MinecraftModrinth::performInstallOrUpdate($server, static::$modrinthProjectType, $record, $latestVersion, $primaryFile, $installedMod);
                ...
                Action::make('uninstall')
                    ...
                    ->action(function (array $record) {
                        try {
                            ...
                            $safeFilename = MinecraftModrinth::validateFilename($installedMod['filename']);
